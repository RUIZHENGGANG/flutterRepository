...
/// 业务查询里面的展示页面
class ServicesItemBody extends StatefulWidget {

  int index;

  ServicesItemBody(this.index);

  @override
  _ServicesItemBodyState createState() => _ServicesItemBodyState(this.index);
}

class _ServicesItemBodyState extends State<ServicesItemBody> {
  String message;
  int pageIndex;//对应item的index

  _ServicesItemBodyState(this.pageIndex);

  List<String> urls = ["https://www.baidu.com","https://www.sina.com.cn"];
