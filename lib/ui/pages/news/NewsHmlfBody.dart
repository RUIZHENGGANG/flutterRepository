...
/// 新闻动态的韩墨乐坊展示页面
class NewsHmlfBody extends StatefulWidget {
  @override
  _NewsHmlfBodyState createState() => _NewsHmlfBodyState();
}

class _NewsHmlfBodyState extends State<NewsHmlfBody> {
  ...
  Widget build(BuildContext context) {
    return FaiWebViewWidget(
        url: "http://www.sunstarbright.com/",
        callback: callback,
        isLog:true
    );
  }
